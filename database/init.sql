...
INSERT INTO `webshop`.`user` (`discriminator`, `username`, `name`, `password`, `reg_date`, `role`, `surname`, `points`) VALUES ('CUSTOMER', 'jo', 'Jovana', 'jo', '2017-06-01 00:34:01', 'customer', 'Micic', '0');
