...
INSERT INTO `webshop`.`category_limit` (`ccategory_id`, `limit_id`) VALUES ('2', '1');
INSERT INTO `webshop`.`category_limit` (`ccategory_id`, `limit_id`) VALUES ('2', '2');
INSERT INTO `webshop`.`category_limit` (`ccategory_id`, `limit_id`) VALUES ('2', '3');
